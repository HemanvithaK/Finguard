...
def main():
    ...
    model, probs = train_transformer(train_df, test_df, epochs=30)

    # Save model weights
    torch.save(model.state_dict(), "../../data/processed/transformer_v2.pt")
    print("\nModel saved to data/processed/transformer_v2.pt")
    ...
    print("Test results saved to transformer_results.pkl")
